...
const ProgressFlowStepper = ({ steps, currentStepIndex, onStepClick }) => {
    return (jsxRuntimeExports.jsx("div", { style: { display: 'flex', alignItems: 'center' }, children: steps.map((step, index) => {
            const isActive = index === currentStepIndex;
            const isCompleted = step.completed || index < currentStepIndex;
            return (jsxRuntimeExports.jsxs("div", { onClick: () => onStepClick?.(index), style: {
                    ...
                    alignItems: 'center'
                            ...
                            alignItems: 'center',
                            marginRight: '8px'
                        }, children: index + 1 }), jsxRuntimeExports.jsx("span", { children: step.label })] }, index));
        }) }));
};

exports.ProgressFlowStepper = ProgressFlowStepper;
